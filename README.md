...
- **contact.html** - Contact + message form (sends to resort email). Handles: general inquiries, food orders (?order=food), event planning (?inquiry=event), gift card (?inquiry=giftcard)
